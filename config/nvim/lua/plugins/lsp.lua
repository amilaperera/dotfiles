return {
    {
        ...
        config = function()
            ...
            vim.api.nvim_create_autocmd("LspAttach", {
                group = vim.api.nvim_create_augroup("aep-lsp-attach", { clear = true }),
                callback = function(event)
                    ...
                    map("grV", "<cmd>vsplit | lua vim.lsp.buf.definition()<CR>", "Defintion in Vertical Split")
                    map("grS", "<cmd>split | lua vim.lsp.buf.definition()<CR>", "Definition in Horizontal Split")
                    map("grN", "<cmd>tab split | lua vim.lsp.buf.definition()<CR>", "Definition in Tab")
                    ...
                    map("<F2>", vim.lsp.buf.rename, "Rename (same as grn)")
